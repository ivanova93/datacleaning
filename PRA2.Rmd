...
Primero vamos a realizar un modelo de regresión logística binomial entre solo dos atributos, el atributo dependiente para este caso es Survived porque nos interesa predecir quienes fueron los que sobrevivieron y como variable explicativa el género de las personas
