...
Tomando en cuenta la informacion que nos provee el data set, el siguiente trabajo tratará de desarrollar tres modelos supervisados(Arbol de Decisión, Regresió logística y xxxxxx) , que nos ayudará a predecir si un pasajero sobrevivió o no al hundimiento del Titanic, basado en sus atributos.
...
```{r}
###passengers$Age <- log(passengers$Age)
```
